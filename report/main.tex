...
%% hyperref must be loaded (nearly) last: it makes the ToC, cross-references,
%% citations and the PDF sidebar outline clickable.
\usepackage[
    colorlinks=true,
    linkcolor=black,      % internal links: ToC, sections, figures, equations
    citecolor=black,      % \cite links
    urlcolor=blue,        % \url / \href
    linktoc=all,          % both the number and the text in the ToC are links
    bookmarks=true,
    bookmarksnumbered=true,
    bookmarksopen=true,
    bookmarksopenlevel=1,
    pdfauthor={Vaishnavahari Seenivasan},
    pdftitle={Multivariable Control Problems}
]{hyperref}
\usepackage{bookmark}     % more robust PDF outline handling
...
%% Style for pasted MATLAB console output (no highlighting, no line numbers)
\lstdefinestyle{matlabout}{
    language=,
...
\input{2_1_norm_equivalence.tex}
\input{2_2_syszero.tex}
\input{2_3_youla.tex}
